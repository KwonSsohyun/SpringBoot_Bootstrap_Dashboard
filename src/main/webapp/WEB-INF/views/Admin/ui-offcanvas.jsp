...
<jsp:include page="../partials/main.jsp"></jsp:include>
    ...
    <head>
		...
		<jsp:include page="../partials/title-meta.jsp">
		    <jsp:param name="title" value="Offcanvas" />
		</jsp:include>
                                                    ...
                                                    <div class="acitivity-timeline p-4">
                                                        <div class="acitivity-item d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="/resources/bootstrap/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                            </div>
                                                        ...
                                                        <div class="acitivity-item py-3 d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="/resources/bootstrap/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                                ...
                                                                <div class="row border border-dashed gx-2 p-2 mb-2">
                                                                    <div class="col-4">
                                                                        <img src="/resources/bootstrap/images/small/img-2.jpg" alt="" class="img-fluid rounded" />
                                                                    </div>
                                                                    <div class="col-4">
                                                                        <img src="/resources/bootstrap/images/small/img-3.jpg" alt="" class="img-fluid rounded" />
                                                                    </div>
                                                                    <div class="col-4">
                                                                        <img src="/resources/bootstrap/images/small/img-4.jpg" alt="" class="img-fluid rounded" />
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="acitivity-item py-3 d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="/resources/bootstrap/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                                <h6 class="mb-1">Bethany Johnson</h6>
                                                                <p class="text-muted mb-2">added a new member to Nomzie dashboard</p>
                                                        ...
                                                        <div class="acitivity-item py-3 d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="/resources/bootstrap/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <div class="acitivity-item d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="/resources/bootstrap/images/users/avatar-8.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="row gallery-light">
                                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                                            <div class="gallery-box card light mb-0">
                                                                <div class="gallery-container">
                                                                    <a href="#" title="">
                                                                        <img class="gallery-img img-fluid mx-auto" src="/resources/bootstrap/images/small/img-12.jpg" alt="" />
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                                            <div class="gallery-box card light mb-0">
                                                                <div class="gallery-container">
                                                                    <a href="#" title="">
                                                                        <img class="gallery-img img-fluid mx-auto" src="/resources/bootstrap/images/small/img-9.jpg" alt="" />
                                                                    </a>
                                                                </div>
                                                                <div class="box-content px-3 py-2">
                                                                        <div class="gallery-overlay">
                                                        ...
                                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                                            <div class="gallery-box card mb-0">
                                                                <div class="gallery-container">
                                                                    <a href="#" title="">
                                                                        <img class="gallery-img img-fluid mx-auto" src="/resources/bootstrap/images/small/img-11.jpg" alt="" />
                                                                    </a>
                                                                </div>
                                                                <div class="box-content px-3 py-2">
                                                                        <div class="gallery-overlay">
