...
<head>
    ...
    <!-- fullcalendar css -->
    <link href="/resources/bootstrap/libs/fullcalendar/main.min.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <!-- calendar min js -->
    <script src="/resources/bootstrap/libs/fullcalendar/main.min.js"></script>

    <!-- Calendar init -->
    <script src="/resources/bootstrap/js/pages/calendar.init.js"></script>
