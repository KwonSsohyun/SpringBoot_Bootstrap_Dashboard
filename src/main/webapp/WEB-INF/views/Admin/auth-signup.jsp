...
<jsp:include page="../partials/main.jsp"></jsp:include>
    ...
    <body>
                                            ...
                                            <div class="my-auto">
                                                ...
                                                <div class="swiper pagination-dynamic-swiper rounded">
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="text-center">
                                                                <h5 class="font-size-20 mt-4 text-white mb-0">âI've learned that
        ...
        <!-- validation init -->
        <script src="/resources/bootstrap/js/pages/form-validation.init.js"></script>
        <!-- password create init -->
        <script src="/resources/bootstrap/js/pages/passowrd-create.init.js"></script>
