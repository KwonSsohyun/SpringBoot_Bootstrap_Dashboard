...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="Wizard" />
	</jsp:include>
...
<body>
                                                ...
                                                <div>
                                                    <div class="text-center">
                                                        <div class="profile-user position-relative d-inline-block mx-auto mb-2">
                                                            <img src="/resources/bootstrap/images/users/user-dummy-img.jpg" class="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile-image">
    ...
    <!-- form wizard init -->
    <script src="/resources/bootstrap/js/pages/form-wizard.init.js"></script>
