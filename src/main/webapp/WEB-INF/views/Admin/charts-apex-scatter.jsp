...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="Apex Scatter Charts" />
	</jsp:include>
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <%-- 페이지 타이틀 --%>
                   	<jsp:include page="../partials/page-title.jsp">
   						...
   						<jsp:param name="title" value="Scatter Charts" />
					</jsp:include>
    ...
    <!-- scatter charts init -->
    <script src="/resources/bootstrap/js/pages/apexcharts-scatter.init.js"></script>
