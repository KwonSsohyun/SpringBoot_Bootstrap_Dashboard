...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="Create Invoice" />
	</jsp:include>

    <!-- dropzone css -->
    <link rel="stylesheet" href="/resources/bootstrap/libs/dropzone/dropzone.css" type="text/css" />
...
<body>
                                ...
                                <form class="needs-validation" novalidate id="invoice_form">
                                            ...
                                            <div class="col-lg-4 ms-auto">
                                                <div class="profile-user mx-auto  mb-3">
                                                    ...
                                                    <label for="profile-img-file-input" class="d-block" tabindex="0">
                                                        <span class="overflow-hidden border border-dashed d-flex align-items-center justify-content-center rounded p-5 py-4" style="height: 60px; width: 256px;">
                                                            <img src="/resources/bootstrap/images/logo-dark.png" class="card-logo card-logo-dark user-profile-image img-fluid" alt="logo dark">
                                                            <img src="/resources/bootstrap/images/logo-light.png" class="card-logo card-logo-light user-profile-image img-fluid" alt="logo light">
                                                        </span>
                                                    </label>
                                                </div>
                                    ...
                                    <div class="card-body p-4 border-top border-top-dashed">
                                        <div class="row">
                                            <div class="col-lg-4 col-sm-6">
                                                <div>
                                                    <label for="billingName" class="text-muted text-uppercase">Billing Address</label>
                                                </div>
                                                <div class="mb-2">
                                            ...
                                            <div class="col-sm-6 ms-auto">
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                        <div>
                                                            <label for="shippingName" class="text-muted text-uppercase">Shipping Address</label>
                                                        </div>
                                                        <div class="mb-2">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="table-responsive">
                                            <table class="invoice-table table table-borderless table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            <a href="javascript:new_link()" id="add-item" class="btn btn-soft-info fw-medium"><i class="ri-add-fill me-1 align-bottom"></i> Add Item</a>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td colspan="2" class="p-0">
                                                            <table class="table table-borderless table-sm table-nowrap align-middle mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <th scope="row">Discount <small class="text-muted">(Nomzie15)</small></th>
                                                                        <td>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4">
                                                <div class="mb-2">
                                                    <label for="choices-payment-type" class="form-label text-muted text-uppercase">Payment Details</label>
                                                    <div class="input-light">
                                        ...
                                        <!--end row-->
                                        <div class="mt-4">
                                            <label for="exampleFormControlTextarea1" class="form-label text-muted text-uppercase">NOTES</label>
                                        ...
                                        <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                                            <button type="submit" class="btn btn-info"><i class="bx bx-printer align-middle me-1"></i> Save</button>
                                            <a href="javascript:void(0);" class="btn btn-primary"><i class="bx bx-download align-middle me-1"></i> Download Invoice</a>
                                            <a href="javascript:void(0);" class="btn btn-danger"><i class="bx bx-paper-plane align-middle me-1"></i> Send Invoice</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <!-- dropzone min -->
    <script src="/resources/bootstrap/libs/dropzone/dropzone-min.js"></script>

    <!-- cleave.js -->
    <script src="/resources/bootstrap/libs/cleave.js/cleave.min.js"></script>

    <!--Invoice create init js-->
    <script src="/resources/bootstrap/js/pages/invoice-create.init.js"></script>
