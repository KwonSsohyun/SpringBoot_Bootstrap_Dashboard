...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="Nestable List" />
	</jsp:include>
...
<body>
                                        ...
                                        <div class="list-group-item nested-1">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="/resources/bootstrap/images/users/avatar-1.jpg" alt="" class="img-fluid rounded-circle">
                                                </div>
                                            ...
                                            <div class="list-group nested-list nested-sortable">
                                                <div class="list-group-item nested-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-xs flex-shrink-0 me-3">
                                                            <img src="/resources/bootstrap/images/users/avatar-2.jpg" alt="" class="img-fluid rounded-circle">
                                                        </div>
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="list-group nested-list nested-sortable">
                                                        <div class="list-group-item nested-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                                    <img src="/resources/bootstrap/images/users/avatar-4.jpg" alt="" class="img-fluid rounded-circle">
                                                                </div>
                                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="list-group nested-list nested-sortable">
                                                        <div class="list-group-item nested-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                                    <img src="/resources/bootstrap/images/users/avatar-6.jpg" alt="" class="img-fluid rounded-circle">
                                                                </div>
                                                                <div class="flex-grow-1">
                                                            ...
                                                            <div class="list-group nested-list nested-sortable">
                                                                <div class="list-group-item nested-4">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar-xs flex-shrink-0 me-3">
                                                                            <img src="/resources/bootstrap/images/users/avatar-7.jpg" alt="" class="img-fluid rounded-circle">
                                                                        </div>
                                                                        <div class="flex-grow-1">
    ...
    <!-- sortablejs -->
    <script src="/resources/bootstrap/libs/sortablejs/Sortable.min.js"></script>

    <!-- nestable init js -->
    <script src="/resources/bootstrap/js/pages/nestable.init.js"></script>
