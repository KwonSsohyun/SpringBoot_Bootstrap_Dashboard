...
<jsp:include page="../partials/main.jsp"></jsp:include>
    ...
    <head>
		...
		<jsp:include page="../partials/title-meta.jsp">
		    <jsp:param name="title" value="Basic Elements" />
		</jsp:include>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            <p class="text-muted">Use any checkbox, radio, or button option within an input groupâs addon instead of text. We recommend adding <code>mt-0</code> class to the <code>form-check-input</code> when thereâs no visible text next to the input.</p>
                                            <div class="row g-3">
                                                <div class="col-lg-6">
                                                    <div class="input-group">
