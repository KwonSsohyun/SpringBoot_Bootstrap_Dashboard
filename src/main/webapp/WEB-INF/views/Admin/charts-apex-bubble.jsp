...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="Apex Bubble Charts" />
	</jsp:include>
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <%-- 페이지 타이틀 --%>
                   	<jsp:include page="../partials/page-title.jsp">
   						...
   						<jsp:param name="title" value="Bubble Charts" />
					</jsp:include>
    ...
    <!-- bubblecharts init -->
    <script src="/resources/bootstrap/js/pages/apexcharts-bubble.init.js"></script>
