...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="Apex Timeline Charts" />
	</jsp:include>
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <%-- 페이지 타이틀 --%>
                   	<jsp:include page="../partials/page-title.jsp">
   						...
   						<jsp:param name="title" value="Timeline Charts" />
					</jsp:include>
    ...
    <script src="/resources/bootstrap/libs/moment/min/moment.min.js"></script>

    <!-- timeline charts init -->
    <script src="/resources/bootstrap/js/pages/apexcharts-timeline.init.js"></script>
