...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="Tom Select" />
	</jsp:include>

    <link href="/resources/bootstrap/libs/tom-select/css/tom-select.bootstrap5.min.css" rel="stylesheet" />
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">This example provides a simple demonstration of how to override the default templates for options and items along with proper use of the <code>escape()</code> method.</p>
                                    <div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">An example showing how you might go about creating contact selector like those used in Email apps.</p>
                                    <div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Browsers will prevent users from submitting this form unless the <code>&lt;select required&gt;</code> field has a value. Your browser may display a message along the lines of "Please fill out this field" when trying to submit the form.</p>
                                    <div>
                                        <form>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">With a few changes, you can enhance your communication with features provided by frameworks like Bootstrap.</p>
                                    <div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Images can be added to option and item elements with custom render templates and data-* attributes</p>
                                    <div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <select class="data-flag">
                                            <option value="Ascension Island" data-src="/resources/bootstrap/images/flags/ac.svg">Ascension Island</option>
                                            <option value="Andorra" data-src="/resources/bootstrap/images/flags/ad.svg">Andorra</option>
                                            <option value="United Arab Emirates" data-src="/resources/bootstrap/images/flags/ae.svg">United Arab Emirates</option>
                                            <option value="Afghanistan" data-src="/resources/bootstrap/images/flags/af.svg">Afghanistan</option>
                                            <option value="Antigua and Barbuda" data-src="/resources/bootstrap/images/flags/ag.svg">Antigua and Barbuda</option>
                                            <option value="Anguilla" data-src="/resources/bootstrap/images/flags/ai.svg">Anguilla</option>
                                            <option value="Armenia" data-src="/resources/bootstrap/images/flags/am.svg">Armenia</option>
                                            <option value="Angola" data-src="/resources/bootstrap/images/flags/ao.svg">Angola</option>
                                            <option value="Antarctica" data-src="/resources/bootstrap/images/flags/aq.svg">Antarctica</option>
                                            <option value="Argentina" data-src="/resources/bootstrap/images/flags/ar.svg">Argentina</option>
                                            <option value="American Samoa" data-src="/resources/bootstrap/images/flags/as.svg">American Samoa</option>
                                            <option value="Austria" data-src="/resources/bootstrap/images/flags/at.svg">Austria</option>
                                            <option value="Australia" data-src="/resources/bootstrap/images/flags/au.svg">Australia</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row g-0">
...
<pre class="language-js" style="height: 250px;"><code>new TomSelect('.data-flag', {
    ...
    <script src="/resources/bootstrap/libs/tom-select/js/tom-select.complete.min.js"></script>
    <script src="/resources/bootstrap/libs/tom-select/js/plugins/remove_button.js"></script>

    <script src="/resources/bootstrap/js/pages/tom-select.init.js"></script>
