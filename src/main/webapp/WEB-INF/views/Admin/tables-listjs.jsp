...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="Listjs" />
	</jsp:include>
...
<body>
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="email">marycousar@Nomzie.com</td>
                                            ...
                                            <ul class="list list-group list-group-flush mb-0">
                                                <li class="list-group-item" data-id="1">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="/resources/bootstrap/images/users/avatar-1.jpg">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="list-group-item" data-id="2">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="/resources/bootstrap/images/users/avatar-2.jpg">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="list-group-item" data-id="3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="/resources/bootstrap/images/users/avatar-3.jpg">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="list-group-item" data-id="4">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="/resources/bootstrap/images/users/avatar-4.jpg">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
    ...
    <script src="/resources/bootstrap/libs/list.js/list.min.js"></script>
    <script src="/resources/bootstrap/libs/list.pagination.js/list.pagination.min.js"></script>

    <!-- listjs init -->
    <script src="/resources/bootstrap/js/pages/listjs.init.js"></script>
