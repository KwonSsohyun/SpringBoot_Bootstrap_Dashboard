...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="Scrollbar" />
	</jsp:include>
                                            ...
                                            <div class="mx-n3">
                                                <div data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="primary" style="max-height: 275px;">
                                                    ...
                                                    <a href="#!" class="text-reset notification-item d-block dropdown-item active">
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                                <img src="/resources/bootstrap/images/users/avatar-2.jpg" class="rounded-circle img-fluid" alt="user-pic">
                                                            </div>
                                                            <div class="flex-grow-1 text-muted">
                                                                <h6 class="mb-1 fs-14">Angela Bernier</h6>
                                                                <p class="mb-0">Answered to your comment on the cash flow forecast's graph ð.</p>
                                                            </div>
                                                    ...
                                                    <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                                <img src="/resources/bootstrap/images/users/avatar-8.jpg" class="rounded-circle img-fluid" alt="user-pic">
                                                            </div>
                                                            <div class="flex-grow-1 text-muted">
