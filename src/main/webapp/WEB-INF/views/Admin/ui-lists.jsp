...
<jsp:include page="../partials/main.jsp"></jsp:include>
    ...
    <head>
		...
		<jsp:include page="../partials/title-meta.jsp">
		    <jsp:param name="title" value="Lists" />
		</jsp:include>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item disabled" aria-disabled="true">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="/resources/bootstrap/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle">
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="/resources/bootstrap/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle">
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        Nancy Martino
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="/resources/bootstrap/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle">
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        Henry Baird
                                                    </div>
...
&lt;/ul&gt;</code></pre>
                            ...
                            <div class="col-xxl-4 col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted">Use Bootstrapâs checkboxes within list group items and customize as needed. </p>
                                        <div class="list-group">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/resources/bootstrap/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded" />
                                                                </div>
                                                                <div class="flex-shrink-0 ms-2">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/resources/bootstrap/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded" />
                                                                </div>
                                                                <div class="flex-shrink-0 ms-2">
