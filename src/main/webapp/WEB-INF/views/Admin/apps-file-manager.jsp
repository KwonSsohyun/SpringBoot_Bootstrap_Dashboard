...
<head>
	...
	<jsp:include page="../partials/title-meta.jsp">
	    <jsp:param name="title" value="File Manager" />
	</jsp:include>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-9">
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="search-box mb-2 me-2">
                                                <div class="position-relative">
                                                    ...
                                                    <i class="bx bx-search search-icon fs-18"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-8 col-sm-6">
                                            <div class="mt-4 mt-sm-0 d-flex align-items-center justify-content-sm-end">
                                                ...
                                                <div class="mb-2 me-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="#"><i class="bx bxs-folder fs-18-outline me-1"></i> Folder</a>
                                                ...
                                                <div class="dropdown mb-0">
                                                    <a class="btn btn-link text-muted p-1 mt-n2" role="button" data-bs-toggle="dropdown" aria-haspopup="true">
                                    ...
                                    <h5 class="fs-16 me-3 mb-0">My Files</h5>
                                        <div class="row mt-4">
                                                    ...
                                                    <div class="card-body p-3">
                                                        <div class="">
                                                            <div class="dropdown float-end">
                                                                <a class="text-muted fs-16" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm align-self-center me-3">
                                                                    <div class="avatar-title rounded bg-primary-subtle  text-primary fs-22">
                                                                        <i class="mdi mdi-google-drive"></i>
                                                                    </div>
                                                                </div>

                                                                <div class="flex-1">
                                                                    <h5 class="fs-15 mb-1">Google Drive</h5>
                                                                    <a href="" class="fs-13 text-muted"><u>View Folder</u></a>
                                                                </div>
                                                            </div>
                                                            <div class="mt-3 pt-1">
                                                                <div class="d-flex justify-content-between">
                                                                    <p class="text-muted fs-13 mb-1">20GB</p>
                                                                    <p class="text-muted fs-13 mb-1">50GB used</p>
                                                                </div>
                                                ...
                                                <div class="card shadow-none border">
                                                    <div class="card-body p-3">
                                                        <div class="">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm align-self-center me-3">
                                                                    <div class="avatar-title rounded bg-info-subtle  text-info fs-22">
                                                                        <i class="mdi mdi-dropbox"></i>
                                                                    </div>
                                                                </div>

                                                                <div class="flex-1">
                                                                    <h5 class="fs-15 mb-1">Dropbox</h5>
                                                                    <a href="" class="fs-13 text-muted"><u>View Folder</u></a>
                                                                </div>
                                                    ...
                                                    <div class="card-body p-3">
                                                        <div class="">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-1">
                                                                    <h5 class="fs-15 mb-1">One Drive</h5>
                                                                    <a href="" class="fs-13 text-muted"><u>View Folder</u></a>
                                                                </div>
                                    ...
                                    <h5 class="fs-16 me-3 mb-0">Folders</h5>
                                        <div class="row mt-4">
                                            <div class="col-xl-4 col-sm-6">
                                                <div class="card shadow-none border">
                                                    <div class="card-body p-3">
                                                        <div class="">
                                                            ...
                                                            <div class="d-flex mt-3">
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="fs-16 text-truncate mb-1"><a href="javascript: void(0);" class="text-body">Analytics</a></h5>
                                                                    <p class="text-muted text-truncate mb-0">12 Files</p>
                                                                </div>
                                                                <div class="align-self-end ms-2">
                                                                    <p class="text-muted mb-0 font-size-13"><i class="bx bx-clock"></i> 15 min ago</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card shadow-none border">
                                                    <div class="card-body p-3">
                                                        <div class="">
                                                            ...
                                                            <div class="d-flex mt-3">
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="fs-16 text-truncate mb-1"><a href="javascript: void(0);" class="text-body">Sketch Design</a></h5>
                                                                    <p class="text-muted text-truncate mb-0">235 Files</p>
                                                                </div>
                                                                <div class="align-self-end ms-2">
                                                                    <p class="text-muted mb-0 font-size-13"><i class="bx bx-clock"></i> 23 min ago</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card shadow-none border">
                                                    <div class="card-body p-3">
                                                        <div class="">
                                                            ...
                                                            <div class="d-flex mt-3">
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="fs-16 text-truncate mb-1"><a href="javascript: void(0);" class="text-body">Applications</a></h5>
                                                                    <p class="text-muted text-truncate mb-0">20 Files</p>
                                                                </div>
                                                                <div class="align-self-end ms-2">
                                                                    <p class="text-muted mb-0 font-size-13"><i class="bx bx-clock"></i> 45 min ago</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap table-hover mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-file fs-18 font-size-16 align-middle text-primary me-2"></i> index.html</a></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                <a class="font-size-16 text-muted" role="button" data-bs-toggle="dropdown" aria-haspopup="true">
                                                                    <i class=" bx bx-dots-horizontal-rounded fs-18"></i>
                                                                </a>
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-folder fs-18 align-middle text-warning me-2"></i> Project-A.zip</a></td>
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-image fs-18 align-middle text-muted me-2"></i> Img-1.jpeg</a></td>
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-box fs-18 align-middle text-muted me-2"></i> update list.txt</a></td>
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-folder fs-18 font-size-16 align-middle text-warning me-2"></i> Project B</a></td>
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-box fs-18 align-middle text-muted me-2"></i> Changes list.txt</a></td>
                                                        <td>09-10-2022, 17:05</td>
                                                        <td>07 KB</td>
                                                        <td>
                                                            <div class="avatar-group">
                                                                <div class="avatar-group-item">
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-image fs-18 align-middle text-success me-2"></i> Img-2.png</a></td>
                                                        <td>09-10-2022, 15:12</td>
                                                        <td>31 KB</td>
                                                        <td>
                                                            <div class="avatar-group">
                                                                <div class="avatar-group-item">
                                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                                        <div class="avatar-xs">
                                                                            <span class="avatar-title rounded-circle bg-pink text-white fs-14">
                                                                                L
                                                                            </span>
                                                                        </div>
                                                                    </a>
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-folder fs-18 font-size-16 align-middle text-warning me-2"></i> Project C</a></td>
                                                        <td>09-10-2022, 10:11</td>
                                                        <td>20 KB</td>
                                                        <td>
                                                            <div class="avatar-group">
                                                                <div class="avatar-group-item">
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript: void(0);" class="text-body fw-medium"><i class="bx bxs-file fs-18 align-middle text-primary me-2"></i> starter-page.html</a></td>
                                                        <td>08-10-2022, 03:22</td>
                                                        <td>11 KB</td>
                                                        <td>
                                                            <div class="avatar-group">
                                                                <div class="avatar-group-item">
                        ...
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                        <div class="">
                                            <h5 class="fs-16">Usage Storage</h5>
                                            <div id="stroked_radialbar" data-colors='["--tb-primary"]' class="apex-charts" dir="ltr"></div> 
                                            <div>
                                                <h5 class="fs-16 mb-3">Recent Files</h5>
                                                <div class="card border shadow-none mb-2">
                                                    <a href="javascript: void(0);" class="text-body">
                                                        <div class="p-2">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm align-self-center me-3">
                                                                    <div class="avatar-title rounded bg-success-subtle  text-success fs-22">
                                                                        <i class="mdi mdi-image"></i>
                                                                    </div>
                                                                </div>
            
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="fs-15 text-truncate mb-1">Images</h5>
                                                    ...
                                                    <a href="javascript: void(0);" class="text-body">
                                                        <div class="p-2">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="fs-15 text-truncate mb-1">Video</h5>
                                                    ...
                                                    <a href="javascript: void(0);" class="text-body">
                                                        <div class="p-2">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="fs-15 text-truncate mb-1">Music</h5>
                                                    ...
                                                    <a href="javascript: void(0);" class="text-body">
                                                        <div class="p-2">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm align-self-center me-3">
                                                                    <div class="avatar-title rounded bg-primary-subtle  text-primary fs-22">
                                                                        <i class="bx bxs-file fs-18"></i>
                                                                    </div>
                                                                </div>
        
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="fs-15 text-truncate mb-1">Document</h5>
                                                                    <p class="text-muted text-truncate mb-0">21 Files</p>
                                                                </div>
                                                ...
                                                <div class="card border shadow-none">
                                                    <a href="javascript: void(0);" class="text-body">
                                                        <div class="p-2">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm align-self-center me-3">
                                                                    <div class="avatar-title rounded bg-warning-subtle  text-warning fs-22">
                                                                        <i class="bx bxs-folder fs-18"></i>
                                                                    </div>
                                                                </div>
        
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="fs-15 text-truncate mb-1">Others</h5>
                                                                    <p class="text-muted text-truncate mb-0">20 Files</p>
                                                                </div>
    ...
    <!-- Dashboard init -->
    <script src="/resources/bootstrap/js/pages/file-manager.init.js"></script>
