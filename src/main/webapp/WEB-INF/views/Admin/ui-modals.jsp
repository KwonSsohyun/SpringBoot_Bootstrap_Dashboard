...
<jsp:include page="../partials/main.jsp"></jsp:include>
    ...
    <head>
		...
		<jsp:include page="../partials/title-meta.jsp">
		    <jsp:param name="title" value="Modals" />
		</jsp:include>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p class="text-muted">Opposites attract, and thatâs a fact. Itâs in our <a href="#" class="tooltip-test text-decoration-underline fw-medium" title="Morton Bayer" data-bs-container="#exampleModalPopovers" data-bs-toggle="tooltip" data-bs-original-title="Tooltip title">graphic design</a> to be interested in the unusual, and thatâs why using <a href="#" class="tooltip-test text-decoration-underline" title="Web Developers" data-bs-toggle="tooltip" data-bs-container="#exampleModalPopovers" data-bs-original-title="Tooltip title">design</a> contrasting colors in Graphic Design is a must.</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <div class="mx-auto">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="d-flex mt-2">
                                                                ...
                                                                <div class="flex-grow-1 ms-2 ">
                                                                    <p class="text-muted mb-0">Opposites attract, and thatâs a fact. Itâs in our nature to be interested in the unusual, and thatâs why using contrasting colors in Graphic Design is a must. Itâs eye-catching, it makes a statement, itâs impressive graphic design. Increase or decrease the letter spacing depending.</p>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex mt-2">
                                                                <div class="flex-shrink-0">
                                                            ...
                                                            <div class="d-flex mt-2">
                                                                ...
                                                                <div class="flex-grow-1 ms-2 ">
                                                                    <p class="text-muted mb-0">Just like in the image where we talked about using multiple fonts, you can see that the background in this graphic design is blurred. Whenever you put text on top of an image, itâs important that your viewers can understand.</p>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex mt-2">
                                                                <div class="flex-shrink-0">
...
&lt;/div&gt;</code></pre>
    ...
    <code>&lt;div class=&quot;modal-dialog modal-dialog-bottom-right&quot;&gt;...&lt;/div&gt;</code></pre>
                                        ...
                                        <div class="card text-center border">
                                            <div class="card-body p-4 pb-0">
                                                ...
                                                <div class="row justify-content-center mt-2">
                                                    <div class="col-lg-10">
                                                        <div>
                                                            <img src="/resources/bootstrap/images/modals/success-payment.png" alt="Mac Image" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- end card body -->
                                        ...
                                        <div class="card text-center border">
                                            <div class="card-body p-4 pb-0">
                                                ...
                                                <div class="row justify-content-center mt-2">
                                                    <div class="col-lg-10">
                                                        <div>
                                                            <img src="/resources/bootstrap/images/modals/login.png" alt="Mac Image" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- end card body -->
                                        ...
                                        <div class="card text-center border">
                                            <div class="card-body p-4 pb-0">
                                                ...
                                                <div class="row justify-content-center mt-2">
                                                    <div class="col-lg-10">
                                                        <div>
                                                            <img src="/resources/bootstrap/images/modals/subscribe.png" alt="Mac Image" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- end card body -->
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div class="subscribe-modals-cover h-100">
                                                                <img src="/resources/bootstrap/images/auth-one-bg.jpg" alt="" class="h-100 w-100 object-cover" style="clip-path: polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- /.modal-content -->
                                        ...
                                        <div class="card text-center border">
                                            <div class="card-body p-4 pb-0">
                                                ...
                                                <div class="row justify-content-center mt-2">
                                                    <div class="col-lg-10">
                                                        <div>
                                                            <img src="/resources/bootstrap/images/modals/signup.png" alt="Mac Image" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- end card body -->
        ...
        <!-- Modal Js -->
        <script src="/resources/bootstrap/js/pages/modal.init.js"></script>
