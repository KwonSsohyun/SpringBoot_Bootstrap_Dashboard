                                        ...
                                        <figure class="sitemap-horizontal">
                                            <ul class="administration">
                                                <li>
                                                    <ul class="director">
                                                        <li>
                                                            <a href="javascript:void(0);" class="fw-semibold bg-primary-subtle  text-primary"><span class="">Nomzie Admin</span></a>
                                                            <ul class="subdirector">
                                                                <li><a href="javascript:void(0);" class="fw-semibold"><span class="text-body">Contact Us</span></a></li>
                                                            </ul>
                                                            <ul class="departments">
                                                                <li><a href="javascript:void(0);" class="fw-semibold"><span class="text-body">Main Pages</span></a></li>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="verti-sitemap">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="p-0 parent-title"><a href="javascript: void(0);" class="fw-medium fs-14">Nomzie</a></li>
                                                    <li>
                                                        <div class="first-list">
                                                            <div class="list-wrap">
