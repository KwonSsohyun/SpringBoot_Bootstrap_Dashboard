                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="alert alert-success" role="alert">
                                                <strong> Yey! Everything worked! </strong> A simple <b>success alert</b> âcheck it out!
                                            </div>

                                            <h6>Danger Alert</h6>
                                            <div class="alert alert-danger mb-xl-0" role="alert">
                                                <strong> Something is very wrong! </strong> A simple <b>danger alert</b> âcheck it out!
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="alert alert-warning" role="alert">
                                                <strong> Uh oh, something went wrong </strong> A simple <b>warning alert</b> âcheck it out!
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                                <strong>Welcome Back!</strong> A simple <b>Dismissible warning alert</b> âcheck it out!
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="alert alert-primary alert-modern alert-dismissible fade show" role="alert">
                                                <i class="bi bi-info-circle icons"></i><strong>This is a information.</strong> You should do something about it.
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                                            ...
                                            <h6>Danger Alert</h6>
                                            <div class="alert alert-danger alert-modern alert-dismissible fade show mb-xl-0" role="alert">
                                                <i class="bi bi-exclamation-diamond icons"></i><strong>This is error.</strong> You should do something about it.
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="alert alert-warning alert-modern alert-dismissible fade show" role="alert">
                                                <i class="bi bi-exclamation-triangle icons"></i><strong>This is warning</strong> You should do something about it.
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
