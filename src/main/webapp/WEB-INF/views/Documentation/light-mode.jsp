                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Light Mode</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Docs</a></li>
                                    <li class="breadcrumb-item active">Light Mode</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Light Mode Setting</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p class="text-muted">You can simply change layout mode to Light by doing the
                                            below changes in the
                                            file <code>src/partials/main.html</code>.</p>
                                        <p class="text-muted mb-0">Simply set the attribute
                                            <code>data-bs-theme="light"</code> to
