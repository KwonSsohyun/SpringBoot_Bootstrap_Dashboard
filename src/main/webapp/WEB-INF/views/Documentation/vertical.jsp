                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Vertical menu configuration</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p class="text-muted">You can change the left side navigation very easily by
                                            adding the below attribute to the body tag in the
                                            <code>src/partials/main.html</code> file.
                                        </p>
                                        <p><code>data-layout="vertical"</code></p>
